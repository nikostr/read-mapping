...
def test_bwa_meme_index():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        sp.check_output([
            ...
            "resources/genome.fasta.pos_packed",
            "resources/genome.fasta.suffixarray_uint64",
            "resources/genome.fasta.suffixarray_uint64_L0_PARAMETERS",
            "resources/genome.fasta.suffixarray_uint64_L1_PARAMETERS",
            "resources/genome.fasta.suffixarray_uint64_L2_PARAMETERS",
            "-f", 
            "-j1",
